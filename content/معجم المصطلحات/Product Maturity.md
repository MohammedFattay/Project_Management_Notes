...
- **علاقته بالأنماط المضادّة**: [[Feature Factory|مصنع الميزات]] هو الشكل النموذجي للمستويين الأوّل والثاني؛ والانتقال إلى المستوى الثالث هو بالضبط الانتقال من قياس النواتج إلى قياس [[Outcome vs Output|المُخرَجات]].
...
3. **موجَّه بالمُخرَجات (Outcome-Driven)** — تُصاغ الأهداف بالمُخرَج لا بقائمة الميزات ([[OKR]] حقيقية)، وللفريق **وصول مباشر للعميل** و**بيانات ذاتية الخدمة** (Self-Service Analytics). ما زال نطاق المشكلة يأتي من الأعلى غالبًا، لكن اختيار الحلّ صار للفريق، والقياس بعد الإطلاق ممارسة معتادة.
...
flowchart TD
    ...
    L3["٣ موجَّه بالمُخرَجات — أهداف بالمُخرَج، وصول مباشر للعميل، بيانات ذاتية الخدمة"]
