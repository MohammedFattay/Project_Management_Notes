...
2. **تحديد المُخرَج المستهدف**: تعريف التغيّر السلوكي المطلوب ومؤشره القابل للقياس ([[Outcome vs Output]])، مع خط أساس ورقم هدف وأفق زمني.
...
```mermaid
flowchart TD
    A["مشكلة حقيقية موثّقة ومقاسة"] --> B["تحديد المُخرَج المستهدف Outcome"]
