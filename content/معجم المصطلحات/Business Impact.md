...
- **التمييز الحاسم: الأثر مقابل النشاط مقابل الناتج.** ثلاثة مستويات تُخلط باستمرار:
  ...
  - **المخرَج (Output)**: ما ننتجه — الميزة، التقرير، الوحدة المسلَّمة. راجع [[Outcome vs Output]].
  - **الأثر (Impact)**: ما يتغيّر في نتيجة العمل بسبب أن أحدًا استخدم الناتج فعلًا.
  والفرق بين **الأثر (Outcome)** و**الأثر بعيد المدى (Impact)** فرق درجة لا نوع: الأثر تغيّر في سلوك المستخدم (ارتفعت نسبة إتمام التسجيل)، والأثر على الأعمال ترجمة ذلك السلوك إلى نتيجة اقتصادية (ارتفع عدد الحسابات المدفوعة، فارتفع الإيراد المتكرّر). التتابع المنطقي: نشاط ← ناتج ← مُخرَج ← أثر. وكل حلقة في هذه السلسلة يمكن أن تنكسر: يمكن أن تُنجز نشاطًا بلا ناتج، وناتجًا بلا أثر، ومُخرَجًا بلا أثر تجاري.
