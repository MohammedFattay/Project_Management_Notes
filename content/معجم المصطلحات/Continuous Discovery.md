...
>
> **من التعلّم إلى القرار**: أضيفت الفرصة إلى شجرة الفرص تحت الأثر المستهدف، ووُلّدت ثلاثة حلول: حقل "تعليمات الوصول" يملؤه العميل، وحفظ تلقائي لملاحظة السائق السابق عن العنوان نفسه، وزرّ مراسلة داخل التطبيق. المهندس — وقد سمع القصة بنفسه — أشار إلى أن الحل الثاني يمكن تنفيذه في أيام لأن البيانات موجودة أصلًا في السجلّات. جُرّب على منطقة واحدة أولًا وقيس أثره على المؤشّر المستهدَف قبل تعميمه.
>
...
1. **حدّد الأثر المستهدف (Outcome)** الذي سيوجّه الاكتشاف هذا الربع؛ بلا أثر تصبح المقابلات فضولًا مشتّتًا.
...
8. **اختبر الحلول بتجارب صغيرة** وقِس أثرها على الأثر المستهدَف.
...
> - **أرشفة الملاحظات بلا بنية**: تتراكم مئات الملاحظات في مستند لا يُقرأ، ويعاد اكتشاف المعروف. الحل: تحويل كل مقابلة فورًا إلى فرص محدّدة في شجرة الفرص المرتبطة بالأثر المستهدَف.
