...
| علاقته بالمنتج | يتعلّق بـ**الناتج** (`Output`) | يتعلّق بـ**المخرَج** ([[Outcome vs Output\|Outcome]]) |
