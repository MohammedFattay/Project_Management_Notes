...
- **ليست مواصفة تقنية.** لا تقول كيف يُبنى الشيء. تقول **ما الذي يجب أن يصير صحيحًا** بعد أن يُبنى. اختيار قاعدة البيانات والبنية والمكتبات قرار هندسي يُوثَّق في `Design Doc` أو [[24 - Architecture Decision Records|ADR]] لا هنا.
...
وثيقة قصيرة جدًّا (صفحة أو أقلّ) توثّق **قرارًا تقنيًّا واحدًا**: السياق · الخيارات · القرار · النتائج المترتّبة. وهي موجودة في المكتبة بتفصيلها في [[24 - Architecture Decision Records|سجلّ قرار معماري]].
...
**الوثائق المجاورة:** [[BRD]] · [[Software Requirements Specification|SRS]] · [[SOW]] · [[11 - User Stories|قصص المستخدم]] · [[24 - Architecture Decision Records|ADR]] · [[Working Backwards|العمل بالعكس]] · [[Shape Up|التشكيل والشهيّة]] · [[Docs as Code|التوثيق ككود]] · [[Single Source of Truth|مصدر الحقيقة الواحد]]
