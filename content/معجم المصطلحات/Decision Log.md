...
- **التمييز عن السجلات الأخرى:**
  ...
  - **مقابل [[24 - Architecture Decision Records|ADR]] (Architecture Decision Record)**: سجل قرارات المعمارية هو النظير التقني المتخصّص، يُحفَظ عادةً داخل مستودع الكود بصيغة ملفات Markdown مرقّمة، ويوثّق القرارات المعمارية (اختيار قاعدة بيانات، نمط تكامل، بروتوكول). العلاقة تكاملية: الـ ADR يخدم فريق الهندسة بتفصيل تقني عميق، وسجل القرارات على مستوى المشروع يخدم الحوكمة وأصحاب المصلحة؛ ويُفضَّل أن يشير أحدهما إلى الآخر عندما يكون للقرار التقني أثر تجاري أو زمني.
...
7. تبليغ القرار للأطراف المتأثرة، وربطه بما ينبثق عنه: [[Change Request]] إن مسّ خط الأساس، أو [[24 - Architecture Decision Records|ADR]] إن كان معماريًا، أو بند في [[Risk Register]] إن ولّد مخاطرة جديدة.
...
> - **خلط القرارات التقنية العميقة بسجل المشروع**: يُثقل السجل الإداري بتفاصيل لا يقرؤها أصحاب المصلحة. الحل: توثيق القرارات المعمارية في [[24 - Architecture Decision Records|ADR]] داخل المستودع، وإدراج إحالة مختصرة إليها في سجل المشروع عند وجود أثر زمني أو مالي.

## 🔗 مصطلحات ومفاهيم ذات صلة
[[RAID Log]] | [[Change Request]] | [[24 - Architecture Decision Records|ADR]] | [[Issue Log]] | [[Risk Register]] | [[Single Source of Truth]] | [[Governance]] | [[SPADE]]
