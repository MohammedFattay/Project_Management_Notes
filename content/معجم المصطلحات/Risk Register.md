...
- في المشاريع الأكبر، يتوسّع سجل المخاطر أحياناً إلى [[RAID Log]] الذي يضيف تتبّع الافتراضات (Assumptions) والقضايا الفعلية (Issues) والاعتماديات (Dependencies) إلى جانب المخاطر. **والوثيقتان لا تتنافسان**: هذه أداة استعداد تُعمِّق نوعًا واحدًا، وتلك أداة تشغيل تُلخّص أربعة — وجدول التمييز بينهما مبسوط في [[RAID Log|صفحة سجلّ RAID]].
- يُشتقّ من هذا السجلّ **مؤشّرات الخطر** ([[KRI]])، وهي أرقام تُرصد لتنذر باقتراب الخطر قبل وقوعه، فتحوّل السجلّ من وثيقة تُراجَع دوريًّا إلى نظام يُنبّه من تلقائه.
