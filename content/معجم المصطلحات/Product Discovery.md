...
- **عند امتلاء الـ Backlog بطلبات متضاربة من الجهات المعنية**: الاكتشاف يحوّل النقاش من "طلب من قال" إلى "أي فرصة تخدم الأثر المستهدف"، وهو ما تنظّمه [[Opportunity Solution Tree]].
...
1. **حدّد الأثر المستهدف (Outcome)** الذي تسعى إليه، لا الميزة. راجع [[Outcome vs Output]].
