...
## جدول التمييز: سجلّ RAID مقابل سجلّ المخاطر

الوثيقتان تُخلطان دائمًا لأن أوّل حرف من RAID هو المخاطر نفسها. **والفرق ليس في الأهمية بل في وظيفة الوثيقة**: إحداهما أداة **إدارة يومية شاملة**، والأخرى أداة **تحليل عميق لنوع واحد**. ومن ثمّ فهما لا تتنافسان، وقد تجتمعان في المشروع الواحد:

| وجه المقارنة | سجلّ RAID | [[Risk Register\|سجلّ المخاطر]] |
|---|---|---|
| **ما يغطّيه** | أربعة أنواع: مخاطر · افتراضات · مشكلات · تبعيات | نوع واحد: المخاطر وحدها |
| **عمق التناول لكل بند** | سطر حالة ومتابعة | تقييم احتمال وأثر، واستراتيجية استجابة، ومالك خطر، وخطّة طوارئ |
| **السؤال الذي يجيب عنه** | ما الذي يشغل هذا المشروع الآن؟ | ما الذي قد يقع، وما استعدادنا له؟ |
| **إيقاع الاستعمال** | اجتماع المتابعة الأسبوعي | التخطيط ثم المراجعات الدورية للمخاطر |
| **من يقرؤه عادةً** | الفريق ومدير المشروع | الراعي ولجنة الحوكمة ومدقّق المخاطر |
| **صلته بالميزانية** | لا صلة مباشرة | يُشتقّ منه [[Contingency Reserve\|احتياطي الطوارئ]] |
| **علامة إهماله** | بنود لم تتغيّر حالتها بين اجتماعين | خطرٌ وقع ولم تكن له خطّة استجابة مكتوبة |

> **السؤال الفارق:** سجلّ RAID يسأل: **ما الذي يجب أن نتكلّم فيه هذا الأسبوع؟** وسجلّ المخاطر يسأل: **ما الذي أعددنا له إن وقع؟** — فالأوّل أداة تشغيل، والثاني أداة استعداد.

**ومتى يُكتفى بأحدهما؟** في المشاريع الصغيرة والمتوسّطة يكفي سجلّ RAID وحده غالبًا، ويُعمَّق فيه عمود المخاطر. أمّا حيث تكون المخاطر كثيرة أو شديدة الأثر — أو حيث يُطلب احتياطي طوارئ مبرَّر، أو تُوجب جهة رقابية توثيقًا — **فسجلّ المخاطر مستقلٌّ لازم**، ويبقى RAID لوحةَ متابعةٍ تُلخّص أشدّه فقط. **والخطأ ليس في اختيار أحدهما، بل في الاحتفاظ بالاثنين ثم تركهما يتناقضان** — إذ يصير لكل خطر حالتان مختلفتان، فلا يُدرى أيّهما المعتمد.
